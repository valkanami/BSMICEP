...
@Component({
  selector: 'app-columnas-carbon',
  standalone: true,
  imports: [CommonModule, HttpClientModule, FormsModule],
  templateUrl: './columnas-carbon.component.html',
  styleUrls: ['./columnas-carbon.component.css']
})
export class ColumnasCarbonComponent implements OnInit {
  datosOriginales: any[] = [];
