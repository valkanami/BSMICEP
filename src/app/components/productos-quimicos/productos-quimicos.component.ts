...
@Component({
  selector: 'app-productos-quimicos',
  standalone: true,
  imports: [CommonModule, HttpClientModule, FormsModule],
  templateUrl: './productos-quimicos.component.html',
  styleUrls: ['./productos-quimicos.component.css']
})
export class ProductosQuimicosComponent implements OnInit {
  datosOriginales: any[] = [];
