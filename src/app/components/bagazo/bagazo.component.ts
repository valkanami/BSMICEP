...
export class BagazoComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public limits: Limit[] = [
    { id: 1, name: '', value: null, color: 'rgba(255, 99, 132, 1)', axis: 'y', unit: '' },
    { id: 2, name: '', value: null, color: 'rgba(54, 162, 235, 1)', axis: 'y1', unit: '' }
  ];
  ...
  public readonly APARTADO_FILTRADO = 'Humedad y Pol en el Bagazo';
