...
@Component({
  selector: 'app-ph-agua-torre',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './ph-agua-torre.component.html',
  styleUrls: ['./ph-agua-torre.component.css']
})
export class PhAguaTorreComponent implements OnInit, AfterViewInit, OnDestroy {
