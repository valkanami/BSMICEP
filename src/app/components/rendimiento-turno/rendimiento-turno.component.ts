...
@Component({
  selector: 'app-rendimiento-turno',
  standalone: true,
  imports: [CommonModule, HttpClientModule, FormsModule],
  templateUrl: './rendimiento-turno.component.html',
  styleUrls: ['./rendimiento-turno.component.css']
})
export class RendimientoTurnoComponent implements OnInit {
  datosOriginales: any[] = [];
  ...
  readonly APARTADO_FILTRADO = 'Rendimiento por turno';
