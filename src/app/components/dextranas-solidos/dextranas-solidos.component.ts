...
@Component({
  ...
  templateUrl: './dextranas-solidos.component.html',
  styleUrls: ['./dextranas-solidos.component.css']
})
export class DextranasSolidosComponent implements OnInit, AfterViewInit, OnDestroy {
