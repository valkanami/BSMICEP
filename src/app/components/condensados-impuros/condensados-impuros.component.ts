...
@Component({
  selector: 'app-condensados-impuros',
  standalone: true,
  imports: [CommonModule, HttpClientModule, FormsModule],
  templateUrl: './condensados-impuros.component.html',
  styleUrls: ['./condensados-impuros.component.css']
})
export class CondensadosImpurosComponent implements OnInit {
  datosOriginales: any[] = [];
