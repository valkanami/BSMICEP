...
@Component({
  selector: 'app-rendimiento-cristales-dia',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './rendimiento-cristales-dia.component.html',
  styleUrls: ['./rendimiento-cristales-dia.component.css']
})
export class RendimientoCristalesDiaComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public categories: string[] = ['MASA_A', 'MASA_B', 'MASA_C'];
  ...
  checkApiConnection(): void {
    this.http.get('http://localhost:3000/api/rendimientocristalesdia').subscribe({
      next: (response) => {
