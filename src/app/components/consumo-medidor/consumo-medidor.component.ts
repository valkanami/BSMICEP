...
@Component({
  selector: 'app-consumo-medidor',
  standalone: true,
  imports: [CommonModule, HttpClientModule, FormsModule],
  templateUrl: './consumo-medidor.component.html',
  styleUrls: ['./consumo-medidor.component.css']
})
export class ConsumoMedidorComponent implements OnInit {
  datosOriginales: any[] = [];
  ...
  readonly APARTADO_FILTRADO = 'Consumo de agua por medidor';
