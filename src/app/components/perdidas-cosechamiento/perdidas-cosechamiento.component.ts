          ...
          plugins: {
            ...
            datalabels: {
              ...
              formatter: (value: any, context: any) => {
                // Solo mostrar la etiqueta para el último dataset (el total o similar) o manejar por dataset
                // En este componente parece que se quiere mostrar el valor del último tipo de dato
