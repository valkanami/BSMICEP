...
@Component({
  ...
  templateUrl: './reductores-promedio.component.html',
  styleUrls: ['./reductores-promedio.component.css']
})
export class ReductoresPromedioComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public limits: Limit[] = [
    { id: 26, name: 'Desmenuzado', value: null, color: 'rgb(255, 0, 0)', axis: 'y', unit: '' },
    { id: 27, name: 'Mezclado', value: null, color: 'rgb(0, 255, 0)', axis: 'y', unit: '' },
    { id: 28, name: 'Claro', value: null, color: 'rgb(0, 0, 255)', axis: 'y', unit: '' },
    { id: 29, name: 'Meladura', value: null, color: 'rgb(255, 0, 255)', axis: 'y', unit: '' },
  ];
  ...
  private extractDataTypes(): void {
    ...
    this.originalData.forEach(item => {
      if (item.dato && item.apartado === 'Reductores Promedio') {
  ...
  private preserveOriginalTimes(rawData: any[]): any[] {
    return rawData
      .filter(item => item.apartado === 'Reductores Promedio')
      .map(item => {
        let horaOriginal = '';
        if (item.hora) {
