...
export class ReductoresPromedioComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public categories: string[] = ['DESMENUZADO', 'MEZCLADO', 'CLARIFICADO', 'MELADURA'];
  ...
  checkApiConnection(): void {
    this.http.get('http://localhost:3000/api/reductorespromedio').subscribe({
      next: (response) => {
