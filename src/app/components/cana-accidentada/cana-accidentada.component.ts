...
@Component({
  selector: 'app-cana-accidentada',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './cana-accidentada.component.html',
  styleUrls: ['./cana-accidentada.component.css']
})
export class CanaAccidentadaComponent implements OnInit, AfterViewInit, OnDestroy {
