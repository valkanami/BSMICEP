...
@Component({
  selector: 'app-rezasurina',
  standalone: true,
  imports: [CommonModule, HttpClientModule, FormsModule],
  templateUrl: './rezasurina.component.html',
  styleUrls: ['./rezasurina.component.css']
})
export class RezasurinaComponent implements OnInit {
  datosOriginales: any[] = [];
  ...
  readonly APARTADO_FILTRADO = 'Rezasurina';
