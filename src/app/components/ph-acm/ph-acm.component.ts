...
@Component({
  ...
  templateUrl: './ph-acm.component.html',
  styleUrls: ['./ph-acm.component.css']
})
export class PhAcmComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  filterDataByDate(): void {
    ...
    this.filteredData = this.originalData.filter(item => {
      ...
      return itemDateStr === this.selectedDate && 
             (item.dato === 'Alcalizado' || item.dato === 'Claro' || item.dato === 'Meladura');
    });
