...
@Component({
  selector: 'app-produccion-oficial',
  standalone: true,
  imports: [CommonModule, HttpClientModule, FormsModule],
  templateUrl: './produccion-oficial.component.html',
  styleUrls: ['./produccion-oficial.component.css']
})
export class ProduccionOficialComponent implements OnInit {
  datosOriginales: any[] = [];
  ...
  readonly APARTADO_FILTRADO = 'Producción oficial';
