...
@Component({
  selector: 'app-produccion-fn',
  standalone: true,
  imports: [CommonModule, HttpClientModule, FormsModule],
  templateUrl: './produccion-fn.component.html',
  styleUrls: ['./produccion-fn.component.css']
})
export class ProduccionFnComponent implements OnInit {
  datosOriginales: any[] = [];
