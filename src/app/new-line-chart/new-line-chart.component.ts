    ...
    this.chart = new Chart("NewLineChart", {
      ...
      data: {
        ...
        datasets: [
          {
            label: "PH Meladura",
            data: [6.2, 6.2, 6.3, 6.3, 6.2, 6.3, 6.3, 6.3, 6.2, 6.3, 6.3, 6.2, 6.2, 6.2, 6.1, 6.1, 6.1, 6.2, 6.1, 6.1, 6.1, 6.1, 6.1, 6.2], // Datos iniciales
            borderColor: 'rgb(48, 216, 14)', // Verde
            borderWidth: 2,
            fill: false
          },
          {
            label: "PH Claro",
            data: [7.0, 7.1, 6.9, 6.8, 6.9, 7.2, 6.9, 6.8, 6.7, 6.9, 6.8, 6.9, 6.5, 6.8, 6.7, 6.5, 6.5, 6.7, 6.7, 6.6, 6.7, 6.7, 6.8, 6.9], // Datos iniciales
          ...
          {
            label: "PH Alcalizado",
            data: [7.8, 7.9, 8.0, 7.4, 8.3, 7.5, 8.2, 7.1, 7.7, 7.6, 7.7, 7.4, 7.5, 7.6, 7.6, 7.8, 7.8, 7.6, 7.7, 7.7, 7.6, 7.8, 7.8, 7.7], // Datos iniciales
